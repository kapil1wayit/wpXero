...
namespace App\Services\qboauth;
...
class QuickBooks_IPP_OAuth
{
	...
	public function _generateHeader($params, $normalized) 
	{
		// oauth_signature="' . $this->_escape($params['oauth_signature']) . '", 
                
		$str = 'Authorization:  OAuth realm="", 
	...
	public function _normalize($params)
	{	
		$normalized = array();
	...
	public function _generateSignature($signature, $method, $url, $params = array()) 
	{
		/*
	...
	*/	
	...
	public function _generateSignature_HMAC($sbs, $method, $url, $params = array())
	{
