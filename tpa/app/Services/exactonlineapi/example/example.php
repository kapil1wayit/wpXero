...
require app_path('Services/exactonlineapi/'). 'vendor/autoload.php';
...
{
    $storage = json_decode(file_get_contents(app_path('Services/exactonlineapi/example/').'storage.json'), true);
