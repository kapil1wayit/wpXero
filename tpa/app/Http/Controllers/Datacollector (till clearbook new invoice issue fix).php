        ...
        try {
            ...
            try {
                ...
                $xml = "<read>
                            ...
                            <code>UREN</code>
                            <invoicenumber>03</invoicenumber>
                        </read>";
            ...
            try {
                ...
                $xml = "<read>
                   ...
                   <office>NLA002821</office>
                   <code>INVOICE</code>
                   <invoicenumber>1003</invoicenumber>
                </read>";
            ...
            foreach ($getdetail as $user) {
                ...
                try {
                    ...
                    $xml = '<?xml version="1.0"?>
                            ...
                            <ask>true</ask>
                            1   of  7
                            25/10/2017  09:13Re:    00644506    Vraag   |   Twinapps    Technisch   [   ref:_00D20McGC._500...
                ...
                if (isset($response['Fault']['Error']['@attributes']['code']) && $response['Fault']['Error']['@attributes']['code'] == 3200) {
                    ...
                    foreach ($response['QueryResponse']['Invoice'] as $key => $invoice) {
                        ...
                        if(isset($cusresponse['MiddleName'])){
                            $contactName = $cusresponse.' '.$cusresponse['MiddleName'];
                        }
                        if(isset($cusresponse['FamilyName'])){
                            $contactName = $cusresponse.' '.$cusresponse['FamilyName'];
                        }
...
//              currency code  
                ...
                //echo "<pre>"; print_r($CurrencyCodes); 
                // die;
...
//                            print_r($idArray);
    ...
    public function welcomeToXero() {
        ...
        //$url = "oauth_token=".$_REQUEST['oauth_token']."&oauth_verifier=".$_REQUEST['oauth_verifier']."&org=".$_REQUEST['org'];
        //return Redirect::to('https://frenns.com/apiwork/xr-lib/public.php?success=1&url='.$url);
    }
                        ...
                        if ($created_at1 >= $invoicelastUpdatedTime || empty($invoicelastUpdatedTime)) {
                            ...
                            if (isset($invoice['LineItems']) && !empty($invoice['LineItems'])) {
                                ...
                                foreach ($invoice['LineItems'] as $itemKey => $invoiceLine) {
                                    ...
                                    $updateItemData[$itemKey]['invoice_number'] = isset($value2->reference) ? $value2->reference : '';
