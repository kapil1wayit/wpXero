        ...
        if (!empty($getdetail)) {
            foreach ($getdetail as $user) {
                ...
                if (isset($response['Fault']['Error']['@attributes']['code']) && ($response['Fault']['Error']['@attributes']['code'] == 3200 || $response['Fault']['Error']['@attributes']['code'] == 100)) {
                    ...
                    $cronData[0]['accounting_system'] = $data['accounting_system'];
                    $cronData[0]['item_type'] = $data['item_type'];
                    $cronData[0]['user'] = $data['user'];
                    ...
                    foreach ($response['QueryResponse']['Vendor'] as $key => $customer) {
                        ...
                        if ($customer['MetaData']['CreateTime'] > $lastCronTime || $lastCronTime == '') {
                            ...
                            $customerData[$key]['company_account_number'] = '';
                            $customerData[$key]['company_number'] = '';
                            $customerData[$key]['Type'] = $data['item_type'];
                            $customerData[$key]['cust_supp_company'] = '';
                            $customerData[$key]['custsupp_companynumber'] = '';
                            $customerData[$key]['account_number'] = isset($customer['AcctNum']) ? $customer['AcctNum'] : '';
                            $customerData[$key]['name'] = isset($customer['DisplayName']) ? $customer['DisplayName'] : '';
                            ...
                            $updateCustomerData[$key]['Type'] = $data['item_type'];
                            $updateCustomerData[$key]['cust_supp_company'] = '';
                            $updateCustomerData[$key]['custsupp_companynumber'] = '';
                            $updateCustomerData[$key]['account_number'] = isset($customer['AcctNum']) ? $customer['AcctNum'] : '';
                            $updateCustomerData[$key]['name'] = isset($customer['DisplayName']) ? $customer['DisplayName'] : '';
                ...
                //echo "<pre>"; print_r($cresponse); die('--------------'); 
                if (isset($response['Fault']['Error']['@attributes']['code']) && $response['Fault']['Error']['@attributes']['code'] == 3200) {
                    ...
                    foreach ($cresponse['QueryResponse']['Customer'] as $key => $customer) {
                        ...
                        $uniqueUpdateId = $uniqueFrennsId . '-' . $customer['Id'];
                        $contactName = '';
                        if(isset($customer['GivenName'])){
                            $contactName = $customer['GivenName'];
                        }
                        if(isset($customer['MiddleName'])){
                            $contactName = $contactName.' '.$customer['MiddleName'];
                        }
                        if(isset($customer['FamilyName'])){
                            $contactName = $contactName.' '.$customer['FamilyName'];
                        }
                        ...
                        if ($customer['MetaData']['CreateTime'] > $lastCronTime || $lastCronTime == '') {
                            ...
                            $customerData[$key]['custsupp_companynumber'] = '';
                            $customerData[$key]['account_number'] = isset($customer['AcctNum']) ? $customer['AcctNum'] : '';
                            $customerData[$key]['name'] = $contactName;
                            $customerData[$key]['Address'] = isset($customer['BillAddr']['Line1']) ? $customer['BillAddr']['Line1'] : '';
                            $customerData[$key]['Postcode'] = isset($customer['BillAddr']['PostalCode']) ? $customer['BillAddr']['PostalCode'] : '';
                            $customerData[$key]['City'] = isset($customer['BillAddr']['City']) ? $customer['BillAddr']['City'] : '';
                            $customerData[$key]['country'] = isset($customer['BillAddr']['CountrySubDivisionCode']) ? $customer['BillAddr']['CountrySubDivisionCode'] : '';
                            $customerData[$key]['contact_person'] = $contactName;
                            $customerData[$key]['phone_number'] = isset($customer['PrimaryPhone']['FreeFormNumber']) ? $customer['PrimaryPhone']['FreeFormNumber'] : '';
                            $customerData[$key]['Email'] = isset($customer['PrimaryEmailAddr']['Address']) ? $customer['PrimaryEmailAddr']['Address'] : '';
                            $customerData[$key]['collection_date'] = date('Y-m-d');
                            $customerData[$key]['last_update'] = isset($customer['MetaData']['LastUpdatedTime']) ? $customer['MetaData']['LastUpdatedTime'] : '';
                            ...
                            $updateCustomerData[$key]['custsupp_companynumber'] = '';
                            $updateCustomerData[$key]['account_number'] = isset($customer['AcctNum']) ? $customer['AcctNum'] : '';
                            $updateCustomerData[$key]['name'] = $contactName;
                            $updateCustomerData[$key]['Address'] = isset($customer['BillAddr']['Line1']) ? $customer['BillAddr']['Line1'] : '';
                            $updateCustomerData[$key]['Postcode'] = isset($customer['BillAddr']['PostalCode']) ? $customer['BillAddr']['PostalCode'] : '';
                            $updateCustomerData[$key]['City'] = isset($customer['BillAddr']['City']) ? $customer['BillAddr']['City'] : '';
                            $updateCustomerData[$key]['country'] = isset($customer['BillAddr']['CountrySubDivisionCode']) ? $customer['BillAddr']['CountrySubDivisionCode'] : '';
                            $updateCustomerData[$key]['contact_person'] = $contactName;
                            $updateCustomerData[$key]['phone_number'] = isset($customer['PrimaryPhone']['FreeFormNumber']) ? $customer['PrimaryPhone']['FreeFormNumber'] : '';
                            $updateCustomerData[$key]['Email'] = isset($customer['PrimaryEmailAddr']['Address']) ? $customer['PrimaryEmailAddr']['Address'] : '';
                            $updateCustomerData[$key]['collection_date'] = date('Y-m-d');
                            $updateCustomerData[$key]['last_update'] = isset($customer['MetaData']['LastUpdatedTime']) ? $customer['MetaData']['LastUpdatedTime'] : '';
                ...
                if (isset($response['Fault']['Error']['@attributes']['code']) && $response['Fault']['Error']['@attributes']['code'] == 3200) {
                    ...
                    foreach ($response['QueryResponse']['Invoice'] as $key => $invoice) {
                        ...
                        $uniqueUpdateId = $uniqueFrennsId . '-S' . $invoice['Id'];
                        $customerId     = $uniqueFrennsId .'-'. $invoice['CustomerRef'];
                        
                        $url = $qbRequest . $realm . "/query?query=Select%20*%20from%20Customer%20Where%20Id='".$invoice['CustomerRef']."'";
                        $signature = Helper::qbOauthSignature($url, $user);
                        $cusresponse = Helper::qbCurlRequest($url, $signature[3]);
                        //echo "<prE>"; print_r($cusresponse); die('Invoice Customer');    

                        if (!empty($cusresponse['QueryResponse']['Customer'])) {
                            $cusresponse = $cusresponse['QueryResponse']['Customer'];
                        }else{
                            $cusresponse = array();
                        }
                         $contactName = '';
                        if(isset($cusresponse['GivenName'])){
                            $contactName = (string)$cusresponse['GivenName'];
                        }
                        if(isset($cusresponse['MiddleName'])){
                            $contactName = $contactName.' '.(string)$cusresponse['MiddleName'];
                        }
                        if(isset($cusresponse['FamilyName'])){
                            $contactName = $contactName.' '.(string)$cusresponse['FamilyName'];
                        }
                        ...
                        if ($invoice['MetaData']['CreateTime'] > $lastCronTime || $lastCronTime == '') {
                            ...
                            $invoiceData[$key]['name'] =  $contactName;
                            $invoiceData[$key]['address'] = isset($cusresponse['BillAddr']['Line1']) ? $cusresponse['BillAddr']['Line1'] : '';
                            $invoiceData[$key]['postcode'] = isset($cusresponse['BillAddr']['PostalCode']) ? $cusresponse['BillAddr']['PostalCode'] : '';
                            $invoiceData[$key]['city'] = isset($cusresponse['BillAddr']['City']) ? $cusresponse['BillAddr']['City'] : '';
                            $invoiceData[$key]['country'] = isset($cusresponse['BillAddr']['Country']) ? $cusresponse['BillAddr']['Country'] : '';
                            
                            $invoiceData[$key]['company_number'] = '';
                            $invoiceData[$key]['vat_registration_number'] = '';
                            $invoiceData[$key]['contact_person'] =  $contactName;
                            $invoiceData[$key]['phone_no'] = isset($cusresponse['BillAddr']['Country']) ? $cusresponse['BillAddr']['Country'] : '';
                            $invoiceData[$key]['email'] = isset($invoice['BillEmail']['Address']) ? $invoice['BillEmail']['Address'] : '';
                            $invoiceData[$key]['type'] = $data['item_type'];
                            ...
                            $invoiceData[$key]['currency'] = isset($invoice['CurrencyRef']) ? $invoice['CurrencyRef'] : '';
                            ...
                            $invoiceData[$key]['outstanding_amount'] = isset($invoice['Balance']) ? $invoice['Balance'] : '';
                            $invoiceData[$key]['paid'] = $pay_status;
                            $invoiceData[$key]['pay_date'] = $pay_date;
                            $invoiceData[$key]['invoiceId'] = $invoice['Id'];
                            $invoiceData[$key]['customerId'] = $customerId;
                            ...
                            $updateInvoiceData[$key]['name'] =  $contactName;
                            $updateInvoiceData[$key]['address'] = isset($cusresponse['BillAddr']['Line1']) ? $cusresponse['BillAddr']['Line1'] : '';
                            $updateInvoiceData[$key]['postcode'] = isset($cusresponse['BillAddr']['PostalCode']) ? $cusresponse['BillAddr']['PostalCode'] : '';
                            $updateInvoiceData[$key]['city'] = isset($cusresponse['BillAddr']['City']) ? $cusresponse['BillAddr']['City'] : '';
                            $updateInvoiceData[$key]['country'] = isset($cusresponse['BillAddr']['Country']) ? $cusresponse['BillAddr']['Country'] : '';
                            ...
                            $updateInvoiceData[$key]['type'] = $data['item_type'];
                            ...
                            $updateInvoiceData[$key]['currency'] = isset($invoice['CurrencyRef']) ? $invoice['CurrencyRef'] : '';
                            ...
                            $updateInvoiceData[$key]['outstanding_amount'] = isset($invoice['Balance']) ? $invoice['Balance'] : '';
                            $updateInvoiceData[$key]['paid'] = $pay_status;
                            $updateInvoiceData[$key]['pay_date'] = $pay_date;
                            $updateInvoiceData[$key]['invoiceId'] = $invoice['Id'];
                            $updateInvoiceData[$key]['customerId'] = $customerId;
                ...
                ######################## Quickbook Purchase Invoice Section #######################################################

                $url = $qbRequest . $realm . "/query?query=select%20*%20from%20Purchase";
                $signature = Helper::qbOauthSignature($url, $user);
                $response = Helper::qbCurlRequest($url, $signature[3]);
                //echo "#@@#<pre>"; print_r($response); die('Quickbook Invoice Responce 522');
                if (isset($response['Fault']['Error']['@attributes']['code']) && $response['Fault']['Error']['@attributes']['code'] == 3200) {
                    die("Application Authentication Failed For <b>" . $uniqueId . "</b>. Please contact to administrator.");
                } else if (!empty($response['QueryResponse']['Purchase'])) {

                    #Get Last Cron Time
                    $data = array();
                    $data['accounting_system'] = 'quickbook';
                    $data['item_type'] = 'ACCPAY';
                    $data['user'] = $uniqueId;
                    //$lastCronTime = $this->apidetail->getCronTime($data);
                    $lastCronTime = DB::table('appcrontracker')->where('accounting_system', 'quickbook')->where('item_type', 'invoice')->orderBy('id', 'desc')->first();
                    $lastCronTime = isset($lastCronTime->cron_time) ? $lastCronTime->cron_time : '';
                    ...
                    foreach ($response['QueryResponse']['Purchase'] as $key => $invoice) {
                        //echo "******<prE>"; print_r($invoice);die('single purchase invoice');                         
                        
                        $uniqueUpdateId = $uniqueFrennsId . '-P' . $invoice['Id'];
                        $customerId     = $uniqueFrennsId .'-'. $invoice['CustomerRef'];
                        ...
                        //  $contactName = '';
                        // if(isset($cusresponse['GivenName'])){
                        //     $contactName = $cusresponse['GivenName'];
                        // }
                        // if(isset($cusresponse['MiddleName'])){
                        //     $contactName = $contactName.' '.$cusresponse['MiddleName'];
                        // }
                        // if(isset($cusresponse['FamilyName'])){
                        //     $contactName = $contactName.' '.$cusresponse['FamilyName'];
                        // }
                        ...
                        if ($invoice['MetaData']['CreateTime'] > $lastCronTime || $lastCronTime == '') {
                            ...
                            $invoiceData[$key]['company_number'] = '';
                            $invoiceData[$key]['vat_registration_number'] = '';
                            $invoiceData[$key]['contact_person'] =  '';
                            $invoiceData[$key]['phone_no'] = isset($cusresponse['BillAddr']['Country']) ? $cusresponse['BillAddr']['Country'] : '';
                            $invoiceData[$key]['email'] = isset($invoice['BillEmail']['Address']) ? $invoice['BillEmail']['Address'] : '';
                            $invoiceData[$key]['type'] = $data['item_type'];
                            $invoiceData[$key]['invoice_number'] = isset($invoice['DocNumber']) ? $invoice['DocNumber'] : '';
                            ...
                            $invoiceData[$key]['delivery_date'] = '';
                            $invoiceData[$key]['currency'] = isset($invoice['CurrencyRef']) ? $invoice['CurrencyRef'] : '';
                            $invoiceData[$key]['amount'] = isset($invoice['TotalAmt']) ? $invoice['TotalAmt'] : '0.0';
                            $invoiceData[$key]['vat_amount'] = isset($invoice['TxnTaxDetail']['TotalTax']) ? $invoice['TxnTaxDetail']['TotalTax'] : '0.0';
                            $invoiceData[$key]['outstanding_amount'] = isset($invoice['Balance']) ? $invoice['Balance'] : '0.0';
                            $invoiceData[$key]['paid'] = '';
                            $invoiceData[$key]['pay_date'] = '';
                            $invoiceData[$key]['invoiceId'] = $invoice['Id'];
                            $invoiceData[$key]['customerId'] = $customerId;
                            $invoiceData[$key]['updateId'] = $uniqueUpdateId;
    ...
    function clearbookData() {
        ...
        if (!empty($getdetail)) {
            for ($i = 0; $i < count($getdetail); $i++) {
                ...
                $idArray = array();                
                $getTodayInsertedInvoice = DB::table('syncinvoice')->where('unique_frenns_id', $uniqueFrennsId)->Where('updateId', 'like', '%clearbook%')->select('updateId')->get();
                //echo '<pre>';print_r($getTodayInsertedInvoice); die;
                if (count($getTodayInsertedInvoice) > 0) {
                    foreach ($getTodayInsertedInvoice as $dbData) {
                        //$exp = explode("-", $dbData->updateId);
                        //$idArray[] = $exp[2];
                        $idArray[] = $dbData->updateId;
                    }
                } else {
                    $idArray[] = array();
                }
                ...
                if (empty($invoices)) {
                  //die("Application Authentication Failed For <b>" . $uniqueId . "</b>. Please contact to administrator.");
                  return view('authenticationFailed', ['uniqueId' => $usernumber, 'response' => 'No invoices found']);
                }
                //                
                //currency code  
                $CurrencyCode = new \Clearbooks_Soap_1_0_Currency();
                $CurrencyCodes = $client->listCurrencies($CurrencyCode);
                foreach ($invoices as $key2 => $value2) {    
                    if($value2->status == "voided") {
                      continue;
                    }               
                    ...
                    if ($invoice_prefix == 'INV') {
                        ...
                        $invoiceUpdateId = $uniqueFrennsId . '-' . $value2->type .'-'. $value2->invoiceNumber;
                        $customerId = $uniqueFrennsId . '-' . $value2->entityId;    
                        ...
                        foreach ($CurrencyCodes as $key => $val) {
                            if ($value2->multicurrency == $val->id) {
                                $updateInvoice[$key2]['currency'] = $val->code;
                            }
                        }
                        
                        //$existId = in_array($invoiceId, $idArray);
                        $existId = in_array($invoiceUpdateId, $idArray);
                        //echo '<pre>';print_r($invoiceUpdateId); echo '<pre>';print_r($idArray); die;
                        if (!empty($existId)) {
                            //echo 'up 1 ';
                            ...
                            $updateInvoice[$key2]['city'] = $entities[0]->town;
                            $updateInvoice[$key2]['country'] = $entities[0]->county;
                            $updateInvoice[$key2]['postcode'] = $entities[0]->postcode;
                            $updateInvoice[$key2]['outstanding_amount'] = $value2->balance;
                            $updateInvoice[$key2]['customerId'] = $customerId;
                            $updateInvoice[$key2]['updateId'] = $invoiceUpdateId;
                            ...
                            if (isset($value2->items)) {
                                ...
                                foreach ($value2->items as $key => $invoiceLine) {
                                    $invoiceItemUpdateId = $uniqueFrennsId . '-' . $value2->type .'-'. $value2->invoiceNumber.'-'.$itemKey;
                            ...
                            foreach ($CurrencyCodes as $key => $val) {
                                if ($value2->multicurrency == $val->id) {
                                    $addInvoice[$key2]['currency'] = $val->code;
                                }
                            }
                            $entityQuery = new \Clearbooks_Soap_1_0_EntityQuery();
                            $entityQuery->id[] = $value2->entityId;
                            ...
                            $addInvoice[$key2]['city'] = $entities[0]->town;
                            $addInvoice[$key2]['country'] = $entities[0]->county;
                            ...
                            $addInvoice[$key2]['customerId'] = $customerId;
                            $addInvoice[$key2]['updateId'] = $invoiceUpdateId;
                ...
                $localContacts = DB::table('syncsupplier')->select('updateId')->where('unique_frenns_id', $uniqueFrennsId)->where('updateId', 'like', '%clearbook%')->get();
    ...
    public function freshbookData() {
        ...
        if (!empty($getdetail)) {
            ...
            for ($i = 0; $i < count($getdetail); $i++) {
                ...
                // print_r($idArray);
                $clientList = json_decode($getClients, true);
                //echo "<pre>"; print_r($clientList['response']); die('----');
                foreach ($clientList['response'] as $valueResponse) {
                ...
                $getTodayInsertedInvoice = DB::table('syncinvoice')->select('updateId')->where('unique_frenns_id', $uniqueFrennsId)->get();
                ...
                foreach ($InvoiceList['response'] as $valueResponse) {
                    foreach ($valueResponse['invoices'] as $key2 => $value2) {
                        ...
                        $updateId = $uniqueFrennsId . '-S-' . $value2['invoiceid'];                        
                        $invoiceIDss = $value2['id'];
                        
                        $existId1 = in_array($invoiceIDss, $idArray1);
                        //echo "<pre>"; print_r($invoiceIDss); print_r($idArray1); die;
                        if (!empty($existId1)) {
                            ...
                            $updateInvDetailList[$key2]['type'] = 'ACCREC';
                            $updateInvDetailList[$key2]['invoiceId'] = $value2['id'];
                            $updateInvDetailList[$key2]['updateId'] = $updateId;
                            #Get Client Details
                            if (!empty($value2['customerid'])) {
                                $customerId  = $uniqueFrennsId .'-'. $value2['customerid'];
                                ...
                                $updateInvDetailList[$key2]['customerId'] = $value2['customerid'];
                            }else{

                                $updateInvDetailList[$key2]['contact_person'] = '';
                                $updateInvDetailList[$key2]['name'] = '';
                                $updateInvDetailList[$key2]['phone_no'] = '';
                                $updateInvDetailList[$key2]['email'] = '';
                                $updateInvDetailList[$key2]['vat_registration_number'] = '';
                                $updateInvDetailList[$key2]['address'] = '';
                                $updateInvDetailList[$key2]['city'] = '';
                                $updateInvDetailList[$key2]['country'] = '';
                                $updateInvDetailList[$key2]['postcode'] = '';
                            ...
                            foreach ($value2['lines'] as $key3 => $value3) {
                                $lines = $key3 + 1;
                                $updateItemId = $updateId.'-'.$lines;
                                $subVatAmount = 0;
                                #vat amout caluclation
                                $subVatAmount = $value3['amount']['amount'] * $value3['taxAmount1'] / 100;
                                $vatAmount = $vatAmount + $subVatAmount;
                                ...
                                $prodDetailList[$kk . $key3]['invoiceline_vat_amount'] = $subVatAmount;
                                $prodDetailList[$kk . $key3]['amount_total'] = $value3['amount']['amount'] + $subVatAmount;
                                $prodDetailList[$kk . $key3]['line_number'] = $lines;
                                $prodDetailList[$kk . $key3]['updateId'] = $updateItemId;

                                DB::table('syncinvoice_item')->where('updateId', $updateItemId)->delete();
                            ...
                            if (!empty($updateInvDetailList)) {                                
                                #add vat amount in invoice data 
                                $updateInvDetailList[$key2]['vat_amount'] = $vatAmount;                              
                            ...
                            $addInvDetailList[$key2]['type'] = 'ACCREC';
                            ...
                            if (!empty($value2['customerid'])) {
                                ...
                                $addInvDetailList[$key2]['customerId'] = $value2['customerid'];
                            
                                $addInvDetailList[$key2]['customerId'] = $customerId;
                            }else{
                                $addInvDetailList[$key2]['contact_person'] = '';
                                $addInvDetailList[$key2]['name'] = '';
                                $addInvDetailList[$key2]['phone_no'] = '';
                                $addInvDetailList[$key2]['email'] = '';
                                $addInvDetailList[$key2]['vat_registration_number'] = '';
                                $addInvDetailList[$key2]['address'] = '';
                                $addInvDetailList[$key2]['city'] = '';
                                $addInvDetailList[$key2]['country'] = '';
                                $addInvDetailList[$key2]['postcode'] = '';                            
                            }
                            //invoice line
                            ...
                            $kk++;
                            //echo "<pre>";print_r($addInvDetailList); die;
                            // add invoice
                            if (!empty($addInvDetailList)) {
                                #add vat amount in invoice data     
                                $addInvDetailList[$key2]['vat_amount'] = $vatAmount;                        
                ...
                $addExpense = '';
                //echo "<pre>"; print_r($expenseInffo); die('Expense data');
                foreach ($expenseInffo['response'] as $valueResponse) {
                    foreach ($valueResponse['expenses'] as $key2 => $value2) {
                        ...
                        $expIDss = $value2['id'];
                        $updateId = $uniqueFrennsId . '-E-' . $value2['expenseid'];
                        $customerId = '';
                        //echo $updatedTimeExpense.'********'.$lastUpdatedTime;                        
                        $existId1 = in_array($expIDss, $idArray1);
                        //echo "<pre>"; print_r($expIDss);  print_r($idArray1);  die;
                        if (!empty($existId1)) {
                            $updateExpense[$key2]['frenns_id'] = $usernumber;
                            $updateExpense[$key2]['unique_frenns_id'] = $uniqueFrennsId;
                            ...
                            $updateExpense[$key2]['type'] = 'ACCPAY';

                            if (!empty($value2['clientid'])) {
                                $customerId = $uniqueFrennsId.'-'.$value2['clientid'];
                                ...
                                $updateExpense[$key2]['customerId'] = $customerId;
                            } else {
                            ...
                            $addExpense[$key2]['unique_frenns_id'] = $uniqueFrennsId;
                            ...
                            $addExpense[$key2]['updateId'] = $updateId;
                            $addExpense[$key2]['type'] = 'ACCPAY';
                            // get client
                            if (!empty($value2['clientid']) && $value2['clientid'] != 0) {
                                $customerId = $uniqueFrennsId.'-'.$value2['clientid'];
                                $clientInfo = "https://api.freshbooks.com/accounting/account/$getAccountId/users/clients/" . $value2['clientid'];
                                $clientInfos = Helper::getCurlData($clientInfo, $parm);
                                $clientInffo = json_decode($clientInfos, true);
                                ...
                                $addExpense[$key2]['customerId'] = $customerId;
                            } else {
    ...
    public function kashflowData() {
        ...
        if (!empty($getdetail)) {
            ...
            for ($i = 0; $i < count($getdetail); $i++) {
                    ...
                    if ($status == 'OK') {
                        ...
                        foreach ($response->$outputArray1 as $key => $value) {
                            ...
                            if ($totalRecord == 1) {
                                ...
                                $updateId = $uniqueFrennsId . '-' . $value->$contactID;
                                ...
                                if ($createdTimeSupplier1 >= $ContactlastUpdatedTime) {
                                    ...
                                    if (!empty($existId)) {
                                        ...
                                        $addSupplierDetailList['contact'][$key][$j]['contactId'] = $contactIDss;
                                    ...
                                    $updateSupplierDetailList['contact'][$key][$j]['contactId'] = $contactIDss;    
                                ...
                                foreach ($value as $key1 => $value1) {
                                    ...
                                    if ($createdTimeSupplier >= $ContactlastUpdatedTime) {
                                        ...
                                        if (!empty($existId)) {
                                            ...
                                            $addSupplierDetailList['contact'][$key][$j]['updateId'] = $updateId;
                                            $addSupplierDetailList['contact'][$key][$j]['contactId'] = $contactIDs;
                                        ...
                                        $updateSupplierDetailList['contact'][$key][$j]['contactId'] = $contactIDs;
                                        $updateSupplierDetailList['contact'][$key][$j]['account_number'] = 0;
                ...
                // get all payment method invoice
                ...
                if ($status1 == 'OK') {
                    ...
                    foreach ($response1->GetInvoices_RecentResult as $key2 => $valueInv) {
                        ...
                        if ($totalRecord == 1) {
                            ...
                            $uniqueUpdateId = $uniqueFrennsId . '-S-' . $valueInv->InvoiceDBID;
                            $customerId     = $uniqueFrennsId .'-'. $valueInv->CustomerID;
                            #delete Old record
                            $deleteInvoiceByUser = DB::table('syncinvoice')->where('updateId', $uniqueUpdateId)->delete();
                            ...
                            $addInvDetailList[$j]['updateId'] = $uniqueUpdateId;
                            $addInvDetailList[$j]['invoiceId'] = $valueInv->InvoiceDBID;
                            $addInvDetailList[$j]['customerId'] = $customerId;
                            ...
                            $addInvDetailList[$j]['type'] = 'ACCREC';
                            ...
                            //echo '<pre>';print_r($response5); die('****************');
                            //invoice line
                            $kkk = 0;
                            $j = 0;
                            foreach ($response5->GetInvoiceByIDResult->Lines as $kkkk => $value) {
                                ...
                                if ($totalLine > 1) {
                                    ...
                                    foreach ($value as $keyss => $value1) {
                                        $updateItemId = $uniqueUpdateId . '-' . $value1->enc_value->LineID; 
                                        #delete old item
                                        DB::table('syncinvoice_item')->where('updateId', $updateItemId)->delete();
                                        ...
                                        $prodDetailList[$kk . $keyss]['updateId'] = $updateItemId;
                                    ...
                                    $updateItemId = $uniqueUpdateId . '-' . $value->enc_value->LineID; 
                                    #delete old item
                                    DB::table('syncinvoice_item')->where('updateId', $updateItemId)->delete();
                                    ...
                                    $prodDetailList[$kkk . $j]['updateId'] = $updateItemId;
                            ...
                            foreach ($valueInv as $key1 => $valueInvArr) {
                                ...
                                $uniqueUpdateId = $uniqueFrennsId . '-S-' . $valueInvArr->InvoiceDBID;
                                $customerId     = $uniqueFrennsId .'-'. $valueInvArr->CustomerID;
                                #delete Old record
                                $deleteInvoiceByUser = DB::table('syncinvoice')->where('updateId', $uniqueUpdateId)->delete();
                                ...
                                $addInvDetailList[$j]['outstanding_amount'] = $valueInvArr->NetAmount + $valueInvArr->VATAmount;
                                ...
                                foreach ($response6->GetInvoiceByIDResult->Lines as $keysss => $value) {
                                    //echo "<prE>"; print_r($value->enc_value); die;
                                    $totalLine = count($value);                                    
                                    ...
                                    if ($totalLine > 1) {
                                        ...
                                        foreach ($value as $keyy => $value1) {
                                            ...
                                            $prodDetailList[$keyy . $j]['updateId'] = $updateItemId;
                                            // print_r($prodDetailList);
                                            ## Delete all invoice items and add new one
                                            //DB::table('syncinvoice_item')->where('updateId', $updateId)->delete();
                                        ...
                                        $prodDetailList[$kk1 . $j]['updateId'] = $updateItemId;
                ...
                //die('Kashflow invoices save successfully');
                
                // get all payment method purchase
                $method1 = 'GetRecPayMethods';
                $paymentMethodResponse = Helper::getKashflow($parameters, $method1);
                //echo '<pre>';print_r($paymentMethodResponse);  die;
                foreach ($paymentMethodResponse->GetRecPayMethodsResult as $methodResult) {
                    foreach ($methodResult as $key => $pMethodResult) {
                        $paymentMethodArray[$pMethodResult->MethodID] = $pMethodResult->MethodName;
                    }
                }
                ...
                if ($status1 == 'OK') {
                    ...
                    //$deleteInvoiceByUser = $this->apidetail->deleteInvoiceByUser($usernumber);
                    //$deleteInvoiceByUser = DB::table('syncinvoice')->where('unique_frenns_id', $uniqueFrennsId)->delete();
                    foreach ($response1->GetReceiptsResult->Invoice as $key2 => $valueInv) {
                        //echo '<pre>';print_r($valueInv); die('****************');
                        $totalRecord = count($valueInv);
                        if ($totalRecord == 1) {
                            // echo 'singleRecord<br>';
                            $createdTimeSupplier1 = $valueInv->InvoiceDate;
                            if ($valueInv->Paid == 1) {
                                ...
                                // get payment method
                                $parameters['InvoiceNumber'] = $valueInv->InvoiceNumber;
                                $method3 = 'GetReceiptPayment';
                                $response3 = Helper::getKashflow($parameters, $method3);
                                if (is_object($response3->GetRecPayMethodsResult->Payment)) {
                                    $paymentId = $response3->GetRecPayMethodsResult->Payment->PayMethod;
                                    $paymentMethods = $paymentMethodArray[$paymentId];
                                    $paydate = $response3->GetRecPayMethodsResult->Payment->PayDate;
                                } else {
                                    $paymentId = $response3->GetRecPayMethodsResult->Payment[0]->PayMethod;
                                    $paymentMethods = $paymentMethodArray[$paymentId];
                                    $paydate = $response3->GetRecPayMethodsResult->Payment[0]->PayDate;
                                }
                            } else {
                                $paid = 'false';
                                $paymentMethods = '';
                            ...
                            $uniqueUpdateId = $uniqueFrennsId . '-P-' . $valueInv->InvoiceDBID;
                            $customerId     = $uniqueFrennsId .'-'. $valueInv->CustomerID;
                            $deleteInvoiceByUser = DB::table('syncinvoice')->where('updateId', $uniqueUpdateId)->delete();
                            ...
                            $addInvDetailList[$j]['collection_date'] = date('Y-m-d');
                            $addInvDetailList[$j]['vat_amount'] = $valueInv->VATAmount;
                            $addInvDetailList[$j]['outstanding_amount'] = $valueInv->NetAmount + $valueInv->VATAmount;
                            $addInvDetailList[$j]['currency'] = $valueInv->CurrencyCode;
                            $addInvDetailList[$j]['paid'] = $paid;
                            $addInvDetailList[$j]['pay_date'] = $paydate;
                            $addInvDetailList[$j]['due_date'] = $valueInv->DueDate;
                            ...
                            //get cutomer details
                            $parameters['SupplierID'] = $valueInv->CustomerID;
                            $method4 = 'GetSupplierByID';
                            $response2 = Helper::getKashflow($parameters, $method4);
                            //echo '<pre>';print_r($response2); die('****************');

                            $addInvDetailList[$j]['contact_person'] = $response2->GetSupplierByIDResult->Contact;
                            $addInvDetailList[$j]['name'] = $response2->GetSupplierByIDResult->Name;
                            $addInvDetailList[$j]['phone_no'] = $response2->GetSupplierByIDResult->Mobile;
                            $addInvDetailList[$j]['email'] = $response2->GetSupplierByIDResult->Email;
                            $addInvDetailList[$j]['type'] = 'ACCPAY';
                            //$addInvDetailList[$key2]['account_number'] = $response2->GetSupplierByIDResult->account_number;
                            $addInvDetailList[$j]['payment_terms'] = $response2->GetSupplierByIDResult->PaymentTerms;
                            $addInvDetailList[$j]['payment_method'] = $paymentMethods;
                            //$addInvDetailList[$key2]['company_number'] = $valueInv->registered_number;
                            $addInvDetailList[$j]['vat_registration_number'] = isset($compantDetail->VatRegistrationNumber) ? $compantDetail->VatRegistrationNumber : '';

                            $addInvDetailList[$j]['address'] = $response2->GetSupplierByIDResult->Address1 . ' ' . $response2->GetSupplierByIDResult->Address2;
                            $addInvDetailList[$j]['city'] = $response2->GetSupplierByIDResult->Address3 . ' ' . $response2->GetSupplierByIDResult->Address4;
                            $addInvDetailList[$j]['country'] = isset($response2->GetSupplierByIDResult->CountryName) ? $response2->GetSupplierByIDResult->CountryName : '';
                            $addInvDetailList[$j]['postcode'] = isset($response2->GetSupplierByIDResult->Postcode) ? $response2->GetSupplierByIDResult->Postcode : '' ;
                            //print_r($addInvDetailList);
                            ...
                            */
                            ...
                            $kkk = 0;
                            $j = 0;
                            foreach ($valueInv->Lines as $kkkk => $value) {
                                //echo "<prE>"; print_r($value); die('---------');
                                $totalLine = count($value);                                
                                //DB::table('syncinvoice_item')->where('updateId', $updateItemId)->delete();
                                if ($totalLine > 1) {
                            ...
                            foreach ($valueInv as $key1 => $valueInvArr) {
                                if ($valueInvArr->Paid == 1) {
                                    ...
                                    if (is_object($response3->GetRecPayMethodsResult->Payment)) {
                                        $paymentId = $response3->GetRecPayMethodsResult->Payment->PayMethod;
                                        $paymentMethods = $GetRecPayMethodsResult[$paymentId];
                                        $paydate = $response3->GetRecPayMethodsResult->Payment->PayDate;
                                    } else {
                                        $paymentId = $response3->GetRecPayMethodsResult->Payment[0]->PayMethod;
                                        $paymentMethods = $GetRecPayMethodsResult[$paymentId];
                                ...
                                $uniqueUpdateId = $uniqueFrennsId . '-P-' . $valueInvArr->InvoiceDBID;
                                $customerId     = $uniqueFrennsId .'-'. $valueInvArr->CustomerID;
                                $deleteInvoiceByUser = DB::table('syncinvoice')->where('updateId', $uniqueUpdateId)->delete();
                                ...
                                $parameters['SupplierID'] = $valueInvArr->CustomerID;
                                $method4 = 'GetSupplierByID';
                                $response2 = Helper::getKashflow($parameters, $method4);
                                //echo '<pre>';print_r($response2); die('****************');

                                $addInvDetailList[$j]['contact_person'] = isset($response2->GetSupplierByIDResult->Contact) ? $response2->GetSupplierByIDResult->Contact : '';
                                $addInvDetailList[$j]['name'] = isset($response2->GetSupplierByIDResult->Name)? $response2->GetSupplierByIDResult->Contact : '';
                                $addInvDetailList[$j]['phone_no'] = isset($response2->GetSupplierByIDResult->Mobile)? $response2->GetSupplierByIDResult->Mobile : '';
                                $addInvDetailList[$j]['email'] = isset($response2->GetSupplierByIDResult->Email)? $response2->GetSupplierByIDResult->Email : '';
                                $addInvDetailList[$j]['type'] = 'ACCPAY';
                                //$addInvDetailList[$key2]['account_number'] = $response2->GetSupplierByIDResult->account_number;
                                $addInvDetailList[$j]['payment_terms'] = isset($response2->GetSupplierByIDResult->PaymentTerms)? $response2->GetSupplierByIDResult->PaymentTerms : '';
                                $addInvDetailList[$j]['payment_method'] = $paymentMethods;
                                $addInvDetailList[$j]['vat_registration_number'] = isset($compantDetail->VatRegistrationNumber) ? $compantDetail->VatRegistrationNumber : '';
                                //$addInvDetailList[$key2]['company_number'] = $valueInv->registered_number;
                                ...
                                // invoice line
                                $kk1 = 0;
                                echo '<pre>';print_r($response6); die('****************');
                                foreach ($response6->GetReceiptsResult->Invoice as $kkkk => $value) {
                                    $totalLine = count($value);
            ...
            foreach ($getdetail as $user) {
                ...
                if ($XeroOAuth->response['code'] == 200) {
                    ...
                    if(count($contacts['Contacts']['Contact']) == 1){
                        ...
                        foreach ($contacts['Contacts'] as $key => $customer) {
                            //echo '<pre>';print_r($customer);  die(' Single Contact');   
                            ...
                            if (!in_array($customer['ContactID'], $localContactsArr) && $contactType != '') {
                                ...
                                $updateCustomerData[$key]['unique_frenns_id'] = $uniqueFrennsId;
                                $updateCustomerData[$key]['company_name'] = isset($customer['CompanyName']) ? $customer['CompanyName'] : '';
                                $updateCustomerData[$key]['company_account_number'] = isset($customer['CompanyAccountNumber']) ? $customer['CompanyAccountNumber'] : '';
                                $updateCustomerData[$key]['company_number'] = isset($customer['CompanyNumber']) ? $customer['CompanyNumber'] : '';
                                $updateCustomerData[$key]['Type'] = $contactType;
                                $updateCustomerData[$key]['cust_supp_company'] = '';
                                $updateCustomerData[$key]['custsupp_companynumber'] = '';
                                $updateCustomerData[$key]['account_number'] = isset($accountDetails['BankAccountNumber']) ? $accountDetails['BankAccountNumber'] : '';
                                $updateCustomerData[$key]['name'] = isset($customer['Name']) ? $customer['Name'] : '';
                                $updateCustomerData[$key]['Address'] = isset($customerAddress['AddressLine1']) ? $customerAddress['AddressLine1'] : '';
                                $updateCustomerData[$key]['Postcode'] = isset($customerAddress['PostalCode']) ? $customerAddress['PostalCode'] : '';
                                $updateCustomerData[$key]['City'] = isset($customerAddress['City']) ? $customerAddress['City'] : '';
                                $updateCustomerData[$key]['country'] = isset($customerAddress['Country']) ? $customerAddress['Country'] : '';
                                ...
                                $updateCustomerData[$key]['Email'] = isset($customer['EmailAddress']) ? $customer['EmailAddress'] : '';
                                $updateCustomerData[$key]['collection_date'] = date('Y-m-d');
                                ...
                                if (!empty($updateCustomerData)) {
                                    ...
                                    $updatePLData = DB::table('syncsupplier')->where('updateId', $uniqueUpdateId)->update($updateCustomerData[$key]);
                                }
                            } else {
                                ## No Action needed.
                            }
                ...
                if ($XeroOAuth->response['code'] == 200) {
                    ...
                    if(count($invoices['Invoices']['Invoice']) == 1){
                        foreach ($invoices['Invoices'] as $key => $invoices) {
                            //echo '*****************<pre>';print_r($invoices); die(' Single Invoice 3292');
                            $cresponse = $XeroOAuth->request('GET', $XeroOAuth->url('Contacts/'.$invoices['Contact']['ContactID'], 'core'), array(), 'xml', '');
                            $invoiceContactInfo = $XeroOAuth->parseResponse($cresponse['response'], $XeroOAuth->response['format']);
                            $invoiceContactInfo = json_decode(json_encode($invoiceContactInfo), true);   
                            $invoiceContactInfo = $invoiceContactInfo['Contacts']['Contact'];
                            //echo '<pre>'; print_r($invoiceContactInfo); die(' Single Invoice 3292');
                            $invoiceContactInfoAddress = $invoiceContactInfo['Addresses']['Address']; 
                            $invoiceContactInfoPhone = $invoiceContactInfo['Phones']['Phone']; 
                            if($invoiceContactInfoAddress[0]['AddressType'] == 'POBOX'){
                                $customerAddress = $invoiceContactInfoAddress[0];
                            }else if($invoiceContactInfoAddress[1]['AddressType'] == 'POBOX'){
                                $customerAddress = $invoiceContactInfoAddress[1];
                            }else{
                                $customerAddress = array();
                            }

                            if(isset($invoiceContactInfoPhone[1]['PhoneNumber'])){
                                $customerPhone = $invoiceContactInfoPhone[1];
                            }else if(isset($invoiceContactInfoPhone[2]['PhoneNumber'])){
                                $customerPhone = $invoiceContactInfoPhone[2];
                            }else if(isset($invoiceContactInfoPhone[3]['PhoneNumber'])){
                                $customerPhone = $invoiceContactInfoPhone[3];
                            }else{
                                $customerPhone = array();
                            }
                             
                            if(isset($invoiceContactInfo['BatchPayments'])){
                              $accountDetails = $invoiceContactInfo['BatchPayments'];
                            }else{
                              $accountDetails = ''; 
                            }
                            ...
                            if ($XeroOAuth->response['code'] == 200) {
                                ...
                                $customerId     = $uniqueFrennsId .'-'. $invoice['Contact']['ContactID'];
                                ...
                                if (!in_array($invoice['InvoiceID'], $localIvoicesArr)) {
                                    ...
                                    $invoiceData[$key]['address'] = isset($customerAddress['AttentionTo']) ? $customerAddress['AttentionTo'] : '';
                                    $invoiceData[$key]['postcode'] = isset($customerAddress['PostalCode']) ? $customerAddress['PostalCode'] : '';
                                    $invoiceData[$key]['city'] = isset($customerAddress['City']) ? $customerAddress['City'] : '';
                                    $invoiceData[$key]['country'] = isset($customerAddress['Country']) ? $customerAddress['Country'] : '';
                                    $invoiceData[$key]['company_number'] = '';
                                    $invoiceData[$key]['vat_registration_number'] = '';
                                    $invoiceData[$key]['account_number'] = isset($accountDetails['BankAccountNumber']) ? $accountDetails['BankAccountNumber'] : '';
                                    $invoiceData[$key]['contact_person'] = isset($invoice['Contact']['Name']) ? $invoice['Contact']['Name'] : '';
                                    $invoiceData[$key]['phone_no'] = isset($customerPhone['PhoneNumber']) ? $customerPhone['PhoneNumber'] : '';
                                    $invoiceData[$key]['email'] = isset($invoiceContactInfo['EmailAddress']) ? $invoiceContactInfo['EmailAddress'] : '';
                                    ...
                                    $invoiceData[$key]['amount'] = isset($invoice['Total']) ? $invoice['Total'] : '';
                                    $invoiceData[$key]['vat_amount'] = isset($invoice['TotalTax']) ? $invoice['TotalTax'] : '';
                                    $invoiceData[$key]['outstanding_amount'] = isset($invoice['AmountDue']) ? $invoice['AmountDue'] : '';
                                    $invoiceData[$key]['paid'] = isset($invoice['FullyPaidOnDate']) ? "true" : "false";
                                    ...
                                    if (isset($invoice['LineItems'])) {
                                        if (isset($invoice['LineItems']['LineItem']['LineItemID'])){
                                            $itemKey = 0;
                                            $invoiceLine = $invoice['LineItems']['LineItem'];
                                            ...
                                            foreach ($invoice['LineItems']['LineItem']  as $itemKey => $invoiceLine) {
                                ...
                                } else if (strtotime($invoice['UpdatedDateUTC']) > strtotime($lastCronTime) && $lastCronTime != '') {
                                    #Upsate invoice data                                
                                    $updateInvoiceData[$key]['frenns_id'] = $uniqueId;
                                    $updateInvoiceData[$key]['unique_frenns_id'] = $uniqueFrennsId;
                                    $updateInvoiceData[$key]['company_account_number'] = '';
                                    ...
                                    $updateInvoiceData[$key]['address'] = isset($customerAddress['AttentionTo']) ? $customerAddress['AttentionTo'] : '';
                                    $updateInvoiceData[$key]['postcode'] = isset($customerAddress['PostalCode']) ? $customerAddress['PostalCode'] : '';
                                    $updateInvoiceData[$key]['city'] = isset($customerAddress['City']) ? $customerAddress['City'] : '';
                                    $updateInvoiceData[$key]['country'] = isset($customerAddress['Country']) ? $customerAddress['Country'] : '';
                                    $updateInvoiceData[$key]['company_number'] = '';
                                    $updateInvoiceData[$key]['vat_registration_number'] = '';
                                    $updateInvoiceData[$key]['account_number'] = isset($accountDetails['BankAccountNumber']) ? $accountDetails['BankAccountNumber'] : '';
                                    ...
                                    $updateInvoiceData[$key]['amount'] = isset($invoice['Total']) ? $invoice['Total'] : '';
                                    $updateInvoiceData[$key]['vat_amount'] = isset($invoice['TotalTax']) ? $invoice['TotalTax'] : '';
                                    $updateInvoiceData[$key]['outstanding_amount'] = isset($invoice['AmountDue']) ? $invoice['AmountDue'] : '';
                                    $updateInvoiceData[$key]['paid'] = isset($invoice['FullyPaidOnDate']) ? "true" : 'false';
                                    ...
                                    if (isset($invoice['LineItems'])) {
                                        ...
                                        if (isset($invoice['LineItems']['LineItem']['LineItemID'])){
                                            ...
                                            $UpdateInvoiceItemData[$key . $itemKey]['amount_total'] = isset($invoiceLine['LineAmount']) ? $invoiceLine['LineAmount'] : '';
                                            $UpdateInvoiceItemData[$key . $itemKey]['invoice_id'] = isset($invoices['InvoiceID']) ? $invoices['InvoiceID'] : '';
                ...
                foreach ($invTypes as $typ) {
                    ...
                    if (!empty($invId)) {
                        ...
                        foreach ($invoiceProducts as $key2 => $value2) {
                            ...
                            $customerId = $uniqueFrennsId . '-' . $value2->contact->id;
                            ...
                            if ($updatedTimeInvoice > $lastUpdatedTime) {
                                ...
                                $updateInvDetailList[$key2]['invoiceId'] = $value2->id;
                                $updateInvDetailList[$key2]['updateId'] = $updateId;
                                $updateInvDetailList[$key2]['customerId'] = $customerId;
                                if ($typ == 'sales_invoices') {
                            ...
                            foreach ($value2->invoice_lines as $kk => $v) {                               
                                ...
                                $prodDetailList[$kk]['updateId'] = $updateItemId;
        ...
        if (!empty($getdetail)) {
            ...
            for ($i = 0; $i < count($getdetail); $i++) {
                ...
                try {
                    ...
                    //echo '<pre>';print_r($invoiceRes); die('Exact Data Sales Invoices Line No. 4532');
                    foreach ($invoiceRes as $j => $valueInv) {
                        //echo '<pre>';print_r($valueInv); die('Exact Data Sales Invoices Single Invoice 4534');
                        $last_modify = date('Y-m-d', substr($valueInv->Modified, 6, 10));
                        $updateId = $uniqueFrennsId . '-' . $valueInv->InvoiceID;
                        $customerId = $uniqueFrennsId . '-' . $valueInv->InvoiceToContactPerson;

                        if ($valueInv->Status == 50) {
                            $paidStatus = "true";
                        } else {
                            $paidStatus = "false";
                        }
                        if (!in_array($valueInv->InvoiceID, $dbInvoiceArr)) {
                            ...
                            $addInvDetailList[$j]['unique_frenns_id'] = $uniqueFrennsId;
                            $addInvDetailList[$j]['frenns_id'] = $usernumber;
                            $addInvDetailList[$j]['creation_date'] = date('Y-m-d', substr($valueInv->InvoiceDate, 6, 10));
                            ...
                            $addInvDetailList[$j]['paid'] = $paidStatus;
                            //$addInvDetailList[$j]['pay_date'] = date('Y-m-d', substr($valueInv->InvoiceDate, 6, 10));
                            $addInvDetailList[$j]['issue_date'] = date('Y-m-d', substr($valueInv->InvoiceDate, 6, 10));
                            ...
                            $updateInvoice[$j]['creation_date'] = date('Y-m-d', substr($valueInv->InvoiceDate, 6, 10));
                            ...
                            $updateInvoice[$j]['issue_date'] = date('Y-m-d', substr($valueInv->InvoiceDate, 6, 10));
                            $updateInvoice[$j]['due_date'] = date('Y-m-d', substr($valueInv->DueDate, 6, 10));
                            $updateInvoice[$j]['customerId'] = $customerId;
        ...
        if (!empty($getdetail)) {
            ...
            for ($i = 0; $i < count($getdetail); $i++) {
                ...
                try {
                    ...
                    $invoice = new \Picqer\Financials\Exact\SalesInvoice($connection);
                    $invoiceRes = $invoice->get();
                    //echo '<pre>'; print_r($invoice);   die('Exact UK Sales Invocies 4860');
                    foreach ($invoiceRes as $j => $valueInv) {
                        $last_modify = date('Y-m-d', substr($valueInv->Modified, 6, 10));
                        $updateId = $uniqueFrennsId . '-' . $valueInv->InvoiceID;

                        if (isset($valueInv->Status) && $valueInv->Status == 50) {
                            $paidStatus = "true";
                        } else {
                            $paidStatus = "false";
                        }
                        ...
                        if (!in_array($valueInv->InvoiceID, $dbInvoiceArr)) {
                            ...
                            //$addInvDetailList[$j]['paid'] = $paidStatus;
                            //$addInvDetailList[$j]['pay_date'] = date('Y-m-d', substr($valueInv->InvoiceDate, 6, 10));
                            $addInvDetailList[$j]['issue_date'] = date('Y-m-d', substr($valueInv->Created, 6, 10));
                            $addInvDetailList[$j]['due_date'] = date('Y-m-d', substr($valueInv->DueDate, 6, 10));
                            $addInvDetailList[$j]['updateId'] = $updateId;
    ...
    public function reeleezeeData() {
        ...
        if (!empty($getdetail)) {
            foreach ($getdetail as $user) {
                ...
                //$currency = 'https://portal.reeleezee.nl/api/v1/Currencies';
                //$result23 = Helper::reeleezeeAuth($currency, $username, $password);

                $invoice = 'https://portal.reeleezee.nl/api/v1/SalesInvoices?$expand=*($levels=max)';
                $result = Helper::reeleezeeAuth($invoice, $username, $password);
                // $result13 = json_decode($result23);
                //echo '<pre>'; print_r($result); die('Reeleezee Invoice Data 5118');
                if (!empty($result)) {
                    $result1 = json_decode($result);
                    //echo '<pre>'; print_r($result1); die('Reeleezee Invoice Data 5118');
                    foreach ($result1->value as $key2 => $value2) {
                        ...
                        if (isset($value2->Entity->id)) {
                            $customerId = $uniqueFrennsId . '-' .$value2->Entity->id;
                        }else{
                            $customerId = '';
                        }

                        if ($value2->TotalNetAmount != 0 && $value2->InvoiceNumber != '') {
                            ...
                            if ($value2->Date >= $lastUpdatedTime || $lastUpdatedTime == '') {
                                ...
                                if (!empty($existId)) {
                                    ...
                                    $updateInvoice[$key2]['paid'] = $paid;
                                    $updateInvoice[$key2]['currency'] = isset($value2->Currency->id) ? $value2->Currency->id : '';
                                    $updateInvoice[$key2]['name'] = isset($value2->Entity->Name) ? $value2->Entity->Name : '';
                                    $updateInvoice[$key2]['email'] = isset($value2->Entity->DefaultInvoiceShippingMethod->FormattedValue) ? $value2->Entity->DefaultInvoiceShippingMethod->FormattedValue : '';
                                    $updateInvoice[$key2]['phone_no'] = isset($value2->Entity->CommunicationChannelList[0]->FormattedValue) ? $value2->Entity->CommunicationChannelList[0]->FormattedValue : '';
                                    $updateInvoice[$key2]['payment_method'] = isset($value2->Entity->PaymentMethod->Description) ? $value2->Entity->PaymentMethod->Description : '';
                                    $updateInvoice[$key2]['customerId'] = $customerId;
                                    ...
                                    $addInvDetailList[$key2]['paid'] = $paid;
                                    $addInvDetailList[$key2]['type'] = 'Sales Invoice';
                                    $addInvDetailList[$key2]['currency'] = isset($value2->Currency->id) ? $value2->Currency->id : '';
                                    $addInvDetailList[$key2]['name'] = isset($value2->Entity->Name) ? $value2->Entity->Name : '';
                                    $addInvDetailList[$key2]['email'] = isset($value2->Entity->DefaultInvoiceShippingMethod->FormattedValue) ? $value2->Entity->DefaultInvoiceShippingMethod->FormattedValue : '';
                                    $addInvDetailList[$key2]['phone_no'] = isset($value2->Entity->CommunicationChannelList[0]->FormattedValue) ? $value2->Entity->CommunicationChannelList[0]->FormattedValue : '';
                                    $addInvDetailList[$key2]['payment_method'] = isset($value2->Entity->PaymentMethod->Description) ? $value2->Entity->PaymentMethod->Description : '';
                                    $addInvDetailList[$key2]['customerId'] = $customerId;
                                    $addInvDetailList[$key2]['updateId'] = $updateId;
                                }
                            ...
                            if (!empty($addInvDetailList)) {
                                ...
                                //echo 'invvvvvoice';
                                DB::table('syncinvoice')->where('updateId', $updateId)->delete();
                                DB::table('syncinvoice')->insert($addInvDetailList[$key2]);
                                $addInvDetailList = '';
                            }
                            #update invoice
       ...
       // echo "<pre>";
        if (!empty($getdetail)) {
            ...
            foreach ($getdetail as $user) {
                ...
                $idArray = array();                
                $getTodayInsertedInvoice = DB::table('syncsupplier')->where('unique_frenns_id', $uniqueFrennsId)->Where('updateId', 'like', '%'.$uniqueFrennsId.'%')->select('updateId')->get();
                //echo '<pre>';print_r($getTodayInsertedInvoice); die;
                if (count($getTodayInsertedInvoice) > 0) {
                    foreach ($getTodayInsertedInvoice as $dbData) {
                        $exp = explode("-", $dbData->updateId);
                ...
                ############################# Freeagent Invoice Section ####################################################
                
                //invoice                             
                // get inserted invoice
                $idArray = array();                
                $getTodayInsertedInvoice = DB::table('syncinvoice')->Where('updateId', 'like', '%'.$uniqueFrennsId.'%')->select('updateId')->get();
                //echo '<pre>';print_r($getTodayInsertedInvoice); die;
                if (count($getTodayInsertedInvoice) > 0) {
                    foreach ($getTodayInsertedInvoice as $dbData) {
                        $exp = explode("-", $dbData->updateId);
                ...
                if (!empty($invoices)) {
                    foreach ($invoices['result']['invoices'] as $key2 => $value2) {
                        ...
                        $updateId = $uniqueFrennsId . '-S-' . $invoiceId;
                        $customerId = $uniqueFrennsId . '-' . $contactId;
                        ...
                        if (!empty($existId)) {
                            ...
                            $updateInvoice[$key2]['paid'] = $paid;
                            $updateInvoice[$key2]['vat_amount'] = isset($value2->sales_tax_value)?$value2->sales_tax_value:'0.00';
                            ...
                            if ($contact['code'] == '200') {
                                ...
                                $updateInvoice[$key2]['contact_person'] = $contact['result']['contact']->first_name . ' ' . $contact['result']['contact']->last_name;
                            ...
                            $updateInvoice[$key2]['type'] = 'ACCREC';
                            ...
                            if (isset($invoice['LineItems']) && !empty($invoice['LineItems'])) {
                                ...
                                foreach ($invoice['LineItems'] as $itemKey => $invoiceLine) {
                                    ...
                                    if (isset($itemId)) {
                                        ...
                                        $updateItemData[$key2 . $itemKey]['unique_frenns_id'] = $uniqueFrennsId;
                                        $updateItemData[$key2 . $itemKey]['invoice_number'] = isset($value2->reference) ? $value2->reference : '';
                                        ...
                                        if (!empty($updateItemData)) {
                                            //$this->apidetail->addInvoiceItem($invoiceItemData);                                              
                                            DB::table('syncinvoice_item')->where('updateId', $updateItemUpdateId)->delete();
                            ...
                            $addInvoice[$key2]['collection_date'] = date('Y-m-d');
                            $addInvoice[$key2]['vat_amount'] = isset($value2->sales_tax_value)?$value2->sales_tax_value:'0.00';
                            ...
                            if ($contact['code'] == '200') {
                                $contact['result']['contact'] = (object) $contact['result']['contact'];
                                $addInvoice[$key2]['contact_person'] = $contact['result']['contact']->first_name . ' ' . $contact['result']['contact']->last_name;
                            ...
                            if (isset($invoice['LineItems']) && !empty($invoice['LineItems'])) {
                                ...
                                foreach ($invoice['LineItems'] as $itemKey => $invoiceLine) {
                                    ...
                                    if (isset($itemId)) {
                                        ...
                                        $invoiceItemData[$itemKey]['unique_frenns_id'] = $uniqueFrennsId;
                                        $invoiceItemData[$itemKey]['invoice_number'] = isset($value2->reference) ? $value2->reference : '';
                ...
                ############################# Freeagent Expense Section ####################################################

                //Expense                
                // get inserted espense
                $idArray = array();                
                $getTodayInsertedInvoice = DB::table('syncinvoice')->where('unique_frenns_id', $uniqueFrennsId)->Where('updateId', 'like', '%'.$uniqueFrennsId.'%')->select('updateId')->get();
                //echo '<pre>';print_r($getTodayInsertedInvoice); die;
                if (count($getTodayInsertedInvoice) > 0) {
                    foreach ($getTodayInsertedInvoice as $dbData) {
                        $exp = explode("-", $dbData->updateId);
                ...
                $invoices = $client->fetch($apiUrl . '/expenses', array(), 'GET', array('Authorization' => 'Bearer ' . $access_token_new, 'User-Agent' => 'App name'));
                //echo "<prE>"; print_r($invoices); print_r($idArray); die('FreeAgent Expense 6564');            

                if (!empty($invoices)) {
                    foreach ($invoices['result']['expenses'] as $key2 => $value2) {
                        $value2 = (object) $value2;                        
                        $invoiceId = substr($value2->url, strrpos($value2->url, '/') + 1);
                        $contactId = substr($value2->user, strrpos($value2->user, '/') + 1);
                        $updateId = $uniqueFrennsId . '-E-' . $invoiceId;
                        $customerId = $uniqueFrennsId . '-' . $contactId;

                        if (isset($value2->gross_value)) {
                            $amount = abs($value2->gross_value);
                        } else if (isset($value2->mileage)) { 
                            $amount = abs($value2->mileage);
                        }else{
                            $amount = 0;
                        }
                        ...
                        if (!empty($existId)) {
                            $updateInvoice[$key2]['frenns_id'] = $uniqueId;
                            $updateInvoice[$key2]['unique_frenns_id'] = $uniqueFrennsId;
                            $updateInvoice[$key2]['creation_date'] = $value2->created_at;;
                            $updateInvoice[$key2]['last_updated'] = $value2->updated_at;
                            //$updateInvoice[$key2]['invoice_number'] = $value2->reference;
                            $updateInvoice[$key2]['amount'] = $amount;
                            $updateInvoice[$key2]['issue_date'] = $value2->dated_on;
                            $updateInvoice[$key2]['collection_date'] = date('Y-m-d');
                            //$updateInvoice[$key2]['outstanding_amount'] = $value2->due_value;
                            $updateInvoice[$key2]['currency'] = $value2->currency;
                           
                            //get contact detail
                            $contact = $client->fetch($value2->user, array(), 'GET', array('Authorization' => 'Bearer ' . $access_token_new, 'User-Agent' => 'App name'));
                            //print_r($contact); die;
                            if ($contact['code'] == '200') {
                                $contact['result']['contact'] = (object) $contact['result']['user'];
                                $updateInvoice[$key2]['contact_person'] = $contact['result']['contact']->first_name . ' ' . $contact['result']['contact']->last_name;
                                $updateInvoice[$key2]['name'] = $contact['result']['contact']->first_name . ' ' . $contact['result']['contact']->last_name;
                                $updateInvoice[$key2]['phone_no'] = isset($contact['result']['contact']->mobile)? $contact['result']['contact']->mobile: '';
                                $updateInvoice[$key2]['email'] = isset($contact['result']['contact']->email)? $contact['result']['contact']->email:'';
                            ...
                            $updateInvoice[$key2]['type'] = 'ACCPAY';
                            //$updateInvoice[$key2]['payment_terms'] = $value2->payment_terms_in_days;
                            $updateInvoice[$key2]['invoiceId'] = $invoiceId;
                            $updateInvoice[$key2]['customerId'] = $customerId;
                            $updateInvoice[$key2]['updateId'] = $updateId;
                            ...
                            #Update Invoice item data                            
                            if (isset($value2->invoice_items) && !empty($value2->invoice_items)) {
                                $invoice['LineItems'] = $value2->invoice_items;
                                $updateItemData = array();
                                #Delete All Lines for this user
                                DB::table('syncinvoice_item')->where('unique_frenns_id', $uniqueFrennsId)->where('invoice_id', $invoiceId)->delete();
                            ...
                            $addInvoice[$key2]['frenns_id'] = $uniqueId;
                            $addInvoice[$key2]['unique_frenns_id'] = $uniqueFrennsId;
                            $addInvoice[$key2]['creation_date'] = $value2->created_at;;
                            $addInvoice[$key2]['last_updated'] = $value2->updated_at;
                            //$addInvoice[$key2]['invoice_number'] = $value2->reference;
                            $addInvoice[$key2]['amount'] = $amount;
                            $addInvoice[$key2]['issue_date'] = $value2->dated_on;
                            $addInvoice[$key2]['collection_date'] = date('Y-m-d');
                            //$addInvoice[$key2]['outstanding_amount'] = $value2->due_value;
                            $addInvoice[$key2]['currency'] = $value2->currency;
