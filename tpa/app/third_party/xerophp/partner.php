 ...
 */
define ( "OAUTH_CALLBACK", 'http://localhost/xerophp/partner.php' );
...
$signatures = array (
		'consumer_key' => 'MORYQILSFDW2RQQ5VIVO7C9VU2XDT6',
		'shared_secret' => 'JXMTC1DSTCJJTOJDZSZEGT2D3RG7VI',
		// API versions
		'core_version' => '2.0',
		'payroll_version' => '1.0',
		'file_version' => '1.0'
...
if (XRO_APP_TYPE == "Partner") {
	...
	$signatures ['curl_ssl_cert'] = BASE_PATH . '/certs/publickey.cer';
	$signatures ['curl_ssl_password'] = 'admin786';
	$signatures ['curl_ssl_key'] = BASE_PATH . '/certs/public_privatekey.pfx';
}*/
