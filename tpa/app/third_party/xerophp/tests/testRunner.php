    ...
    if (isset($_SESSION['access_token']) || XRO_APP_TYPE == 'Private')
        ...
        /*echo '<p><br/><Strong>Accounting API</Strong>
				...
				*/
				 ...
				 echo '<p><br/><Strong>Xero Webhook API</Strong>
					<ul>
						<li><a href="?contacts=1">Refresh Contacts</a></li>
				</ul>';
...
function retrieveSession()
{
    if (isset($_SESSION['access_token'])) {
        ...
        $response['oauth_session_handle']   =    isset($response['oauth_session_handle'])?$_SESSION['session_handle']:'' ;
        return $response;
    } else {
        return false;
    }
