 ...
 */
define("OAUTH_CALLBACK", 'http://localhost/xerophp/xero/index.php');
 ...
 * rsa_private_key: application certificate private key - not needed forhow to create pem private key ubuntu public applications
 * rsa_public_key:  application certificate public cert - not needed for public applications
 */

$signatures = array(
    'consumer_key'     => 'KVEEPVNER2QKLYQZ03RQKZALS8LXLI',
    'shared_secret'    => 'JONEMZKNGWJGCVRS4TPP6FQ70P0UBZ',
    // API versions
    'core_version'=> '2.0',
    'payroll_version'=> '1.0',
    'file_version' => '1.0'
...
if (XRO_APP_TYPE=="Private"||XRO_APP_TYPE=="Partner"||XRO_APP_TYPE=="Public") {
